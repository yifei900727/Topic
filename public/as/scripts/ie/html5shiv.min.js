...
(function (a, b) {
    ...
    function n(a, c, f) {
        ...
        return g.canHaveChildren && !d.test(a) ? f.frag.appendChild(g) : g
    }
    ...
    function q(a) {
        ...
        var c = m(a);
        if (r.shivCSS && !f && !c.hasCSS) {
            c.hasCSS = !!k(a, "article,aside,figcaption,figure,footer,header,hgroup,nav,section{display:block}" + "mark{background:#FF0;color:#000}")
        }
        if (!j) {
            p(a, c)
        }
